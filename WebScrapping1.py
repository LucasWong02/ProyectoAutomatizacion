...
def DescargarFacturas(fechaInicio, FechaFin):
    ...
    if Escribir(browser, '/html/body/table/tbody/tr[2]/td/form/table/tbody/tr[2]/td[2]/input', '20536830376') == False:
        print("Error al escribir RUC")
        return

    if Escribir(browser, '/html/body/table/tbody/tr[2]/td/form/table/tbody/tr[3]/td[2]/input', 'contaproveedor@limatours.com.pe') == False:
        print("Error al escribir usuario")
        return

    if Escribir(browser, '/html/body/table/tbody/tr[2]/td/form/table/tbody/tr[4]/td[2]/input[1]', 'j7vP4MU68Q') == False:
    ...
    while a == True:
        ...
        for i in range(2, 502, 1):#502
            #/html/body/table[2]/tbody/tr/td/div/table/tbody/tr[2]/td[3]/form[1]/table/tbody/tr[2]/td[14]/a[4]
            if DarClick(browser,'/html/body/table[2]/tbody/tr/td/div/table/tbody/tr[2]/td[3]/form[1]/table/tbody/tr[' + str(i) + ']/td[14]/a[4]') == False:
