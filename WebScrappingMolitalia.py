...
def extractDoc(url):
    output_dir = '/Users/ctarazona001/Downloads'
...
def DescargarFacturas(fechaInicio, FechaFin):
    ...
    browser.get('http://asp403r.paperless.com.pe/Facturacion/login.jsp')

    if Escribir (browser, '/html/body/table/tbody/tr[2]/td/form/table/tbody/tr[2]/td[2]/input', '20100035121') == False:
        print ("Error al escribir RUC")
        return

    if Escribir (browser, '/html/body/table/tbody/tr[2]/td/form/table/tbody/tr[3]/td[2]/input', 'jastuvilcapwc') == False:
        print ("Error al escribir usuario")
        return

    if Escribir (browser, '/html/body/table/tbody/tr[2]/td/form/table/tbody/tr[4]/td[2]/input[1]', 'pwc123$') == False:
    ...
    # if DarClick(browser,'/html/body/table[2]/tbody/tr/td/div/table/tbody/tr[2]/td[3]/table[1]/tbody/tr/td[2]/a[9]') == False:
    #    print("Error al dar click en visualizar 11mo elemnto")
    #    return
    ...
    while a == True:
        for i in range (2, 502, 1):  # 502
            if DarClick (browser,'/html/body/table[2]/tbody/tr/td/div/table/tbody/tr[2]/td[3]/form[1]/table/tbody/tr[' + str (i) + ']/td[12]/a[4]') == False:
        ...
        print ("salió del for")
        try:
            print ('/html/body/table[2]/tbody/tr/td/div/table/tbody/tr[2]/td[3]/table[1]/tbody/tr/td[2]/a[' + str (
                contPagina) + ']')
            # /html/body/table[2]/tbody/tr/td/div/table/tbody/tr[2]/td[3]/table[1]/tbody/tr/td[2]/a[6]
...
DescargarFacturas('01-10-2022', '31-10-2022')
