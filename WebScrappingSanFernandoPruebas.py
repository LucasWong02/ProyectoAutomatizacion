...
#XXX
    ...
    if DarClick(browser, '/html/body/form/table[2]/tbody/tr[1]/td/div/table/tbody/tr[3]/td[4]/input') == False:
    ...
    while a == True:
        for i in range(2, 202, 1):#502
            #/html/body/form/table[2]/tbody/tr[2]/td/div/div[1]/table/tbody/tr[2]/td[7]
